...
const categoryIcons: Record<string, React.ReactNode> = {
  ...
  research_planning: (
    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-6.548 0c-1.131.094-1.976 1.057-1.976 2.192V16.5A2.25 2.25 0 0012 18.75h.75" />
    </svg>
  ),
  // 情報・IT系
  programming: (
...
export default function InterviewPage() {
  ...
  const handleStartInterview = (category: string) => {
    router.push(`/interview/live?category=${category}`);
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 md:ml-[96px]">
        <div className="px-6 py-6 max-w-[1400px]">
          {/* Page header */}
          <div className="mb-8">
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight mb-2">AI面接の分野を選ぶ</h1>
                ...
                <div key={group.group} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-indigo-600">{groupIcons[group.group]}</span>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {visibleCategories.map((type) => (
                        <div
                          ...
                          onClick={() => handleStartInterview(type.category)}
                        >
                          <div className="text-indigo-600 mb-3">{getCategoryIcon(type.category)}</div>
