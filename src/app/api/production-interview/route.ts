...
高専生・大学院生の専門知識とポテンシャルを評価する面接問題を${questionCount || (isExpert ? 4 : 5)}問生成してください。
候補者は学生です。実務経験ではなく、学術的な知識・研究能力・応用力を評価する問題を作成してください。
...
面接のルール:
1. 企業の求人要件に基づきつつ、学生の研究経験や学術プロジェクトについて質問してください
2. 技術的基礎力だけでなく、学ぶ姿勢やチームでの協働経験についても聞いてください
